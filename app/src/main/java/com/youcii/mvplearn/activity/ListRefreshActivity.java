...
public class ListRefreshActivity extends BasePresenterActivity<IListRefreshView, ListRefreshPresenter> implements IListRefreshView, Observer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter.startRefresh(deviceList);
    }

    @NotNull
    @Override
    public ListRefreshPresenter initPresenter() {
        return new ListRefreshPresenter(this);
    }
